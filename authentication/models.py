...
class User(AbstractUser):
    ...
    first_name = models.CharField('Primeiro nome', validators=[validador_nome], max_length=20) #mask
    last_name = models.CharField('Sobrenome', max_length=20, validators=[validador_nome]) #mask
    username = None #mask
